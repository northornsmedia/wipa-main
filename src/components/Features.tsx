...
const features = [
  ...
  { title: "Membership Hub + In-House Hub", desc: "Access the Membership Hub + In-House Hub and Business Opportunities.", hoverDetails: "Accelerate your career through guided pairings. Learn from industry veterans or share your own expertise.", style: "bg-pastel-green span-2", img: "/images/networking_mockup_1785398611398.png" },
  ...
  { title: "Mobile Access", desc: "Stay connected wherever you are in the world.", hoverDetails: "Take the entire WIPA network with you. Seamlessly connect on iOS and Android devices.", style: "bg-pastel-purple span-2 row-span-2", img: "/images/mobile_access.png" },
  { title: "Build Your Profile", desc: "Create a standout profile to showcase your expertise.", hoverDetails: "Highlight your achievements, showcase your experience, and build your personal brand within the IP community.", style: "bg-pastel-pink span-2", img: "/images/profile_mockup.webp" },
];

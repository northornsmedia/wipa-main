    ...
    <section className="section section-dark" style={{ position: 'relative', overflow: 'hidden', paddingTop: (!isMounted || !isMobile) ? '' : '40px', paddingBottom: (!isMounted || !isMobile) ? '' : '40px' }}>
      ...
      <div className="container" style={{ padding: '0 40px', position: 'relative', zIndex: 1, textAlign: 'center' }}>
        <FadeIn direction="up">
          ...
          <p className="mobile-text-center" style={{ fontSize: '1.2rem', margin: '0 auto 20px', opacity: 0.9, maxWidth: '900px', lineHeight: 1.6, textAlign: 'center' }}>
          ...
          <p className="mobile-text-center" style={{ fontSize: '1.2rem', margin: '0 auto 60px', opacity: 0.9, maxWidth: '900px', lineHeight: 1.6, textAlign: 'center' }}>

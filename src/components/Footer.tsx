  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        zIndex: 0,
        background: "radial-gradient(125% 125% at 50% 10%, rgba(236, 72, 153, 0.1) 0%, transparent 60%)",
      }}
    />
  );
};
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="brand-section">
            ...
            <p className="brand-text" style={{ fontSize: '0.875rem', lineHeight: '1.6', color: 'var(--text-body)' }}>
          ...
          <div className="footer-links-container">
            {footerLinks.map((section) => (
              <div key={section.title}>
                <h4 style={{ color: 'var(--text-heading)', fontSize: '1.125rem', fontWeight: '600', marginBottom: '24px' }}>
                  {section.title}
                </h4>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {section.links.map((link) => (
                    <li key={link.label}>
                      <Link
                        href={link.href}
                        style={{ color: 'var(--text-body)', textDecoration: 'none', transition: 'color 0.2s ease' }}
        ...
        <hr style={{ borderTop: '1px solid var(--border-subtle)', margin: '32px 0' }} />

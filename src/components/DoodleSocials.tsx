    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      ...
      <ul className="doodle-container">
        <li className="doodle-icon-content">
          <a
            href="https://facebook.com/WomensIPWorld"
            target="_blank"
        ...
        <li className="doodle-icon-content">
          <a
            href="https://instagram.com/womensip"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <li className="doodle-icon-content">
          <a
            href="https://x.com/WomensIPWorld1"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Twitter"
        ...
        <li className="doodle-icon-content">
          <a
            href="https://linkedin.com/company/the-women-s-ip-world-annual"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="doodle-link link-linkedin"
          >
            <svg className="doodle-svg" version="1.1" viewBox="0 0 24 24">
              <path
                className="doodle-path"
          ...
          <div className="doodle-tooltip tooltip-linkedin">LinkedIn</div>
        </li>
      </ul>
    </div>
  );

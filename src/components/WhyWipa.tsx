    ...
    <section className="section section-white" style={{ borderBottom: 'none' }}>
      <div className="container">
        ...
        <p style={{ textAlign: 'center', fontSize: '1.2rem', maxWidth: '800px', margin: '0 auto 60px auto', lineHeight: 1.6 }}>
          The launch of the Women's IP World Alliance represents a unique opportunity to become part of something from the very beginning. As a Founding Member, you will not simply join a community—you will help shape it. You'll receive exclusive launch benefits, gain early access to the platform, and be recognised as one of the professionals who supported the creation of an international community dedicated to advancing women across intellectual property.
        </p>
        ...
        <div className="bento-grid">
          ...
          <div className="bento-card span-2 bg-charcoal">
            ...
            <ul style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.8)', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '10px' }}>

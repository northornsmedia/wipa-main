    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#0f111a", display: "flex", fontFamily: "sans-serif", color: "#fff" }}>
      ...
      <div style={{ flex: 1, padding: "40px", overflowY: "auto", height: "100vh" }}>
        ...
        <FadeIn direction="up" key={activeTab}>
          ...
          {activeTab === 'waiting_list' && <PaginatedTable title="All Waiting List Leads" data={waitingListLeads} columns={['id', 'name', 'email', 'country', 'phone', 'company', 'profession', 'plan', 'business_registration_number', 'date_of_incorporation', 'college_institute', 'student_id', 'created_at']} />}
